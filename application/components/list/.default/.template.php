    ...
    <?foreach ($arResult as $arItem):?>
        <div class="list__item">   
            <div class="list__item__main">
                    ...
                    <div class="list__item__main__links">
                        <a href="<?=$arItem['last_url']?>" title="<?=$arItem['last_name']?>"><?=$arItem['last_name']?></a>
                        <?if(isset($arItem['comment_count'])):?>
                            <a href="" title=""><?=$arItem['comment_count']?> рекомендаций</a>
                        <?endif;?>
                    </div>
                </div>
            </div>
