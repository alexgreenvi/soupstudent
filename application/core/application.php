...
class Application {
    public static function component($component,$name,$template,$arParam){
        ...
        elseif(file_exists($_SERVER['DOCUMENT_ROOT'].'/application/components/'.$component.'/.default/.boot.php')){
            include ($_SERVER['DOCUMENT_ROOT'].'/application/components/'.$component.'/.default/.boot.php');
        };
    ...
    public static function template($name,$template,$arParam){
        $url = $_SERVER['DOCUMENT_ROOT'].'/application/templates/';
