                    ...
                    <div class="content__main">
                        <div class="core__tabs" data-js-core-tabs="content">
                            <div class="core__tabs__item active" data-js-core-tabs-id="1">
                                ...
                                <div class="content__header__description"><p>Здесь Вы можете посмотреть показатели качества обучения, стоимость обучения  , требовательность преподавателей, отношение к студентам, посещаемость занятий Оценки и отзывы о преподавателях и все высшие учебные заведения РФ.</p></div>
                                ...
                                <div class="index__info__text">
                                    ...
                                    <p>Высказать мнение о преподавателе и оценить работу преподавателя Вам поможет наш сайт.<br></p>
